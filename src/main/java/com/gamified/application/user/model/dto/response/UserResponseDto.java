...
public class UserResponseDto {
    ...
    // ============================
    // DTOs ESPECÍFICOS PARA TEACHER
    // ============================
    
    /**
     * Respuesta completa con todos los usuarios relacionados a un teacher
     */
    @Getter
    @Setter
    @NoArgsConstructor
    ...
    @Builder
    @ToString
    public static class TeacherRelatedUsersDto {
        private Long teacherId;
        private String teacherName;
        private Integer classroomsCount;
        private Integer totalStudents;
        private Integer totalGuardians;
        private List<ClassroomWithStudentsDto> classrooms;
        private List<GuardianSummaryDto> uniqueGuardians;
        private TeacherStatsDto statistics;
    ...
    /**
     * Información de un classroom con sus estudiantes
     */
    @Getter
    @Setter
    @NoArgsConstructor
    ...
    @Builder
    @ToString
    public static class ClassroomWithStudentsDto {
        ...
        private List<StudentWithGuardianDto> students;
    ...
    /**
     * Información de un classroom básico
     */
    @Getter
    @Setter
    @NoArgsConstructor
    ...
    /**
     * Estudiante con información de su guardián
     */
    @Getter
    @Setter
    @NoArgsConstructor
    ...
    @Builder
    @ToString
    public static class StudentWithGuardianDto {
        ...
        // Información del guardián (puede ser null)
    ...
    @Builder
    @ToString
    public static class GuardianSummaryDto {
        ...
        private List<String> studentNames; // Solo nombres de los estudiantes
    ...
    public static class TeacherStatsDto {
        ...
        private Integer averageStudentsPerClassroom;
        private Integer activeStudentsLastWeek;
        private Integer activeGuardiansLastWeek;
